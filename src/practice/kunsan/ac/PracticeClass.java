...
public class PracticeClass {
	...
	public static void practice2() { // 1부터 100까지 합산
		...
		/*
		 * 강사님(대표님)이 만든거 int m = 1; final int MAX_VALUE = 100; int sum = 0;
		 * 
		 * while(m < MAX_VALUE + 1) { sum += m; m++; }
		 * 
		 * String outString = "Sum of numbers : " + sum; System.out.println(outString);
		 */
	...
	public static void practice4() { // 입력받은 number만큼의 별표 출력하기
		...
		/*
		 * System.out.print("Enter line number: "); try(Scanner sc = new
		 * Scanner(system.in)) { //try는 {}안에 실행이 되고 끝나면 자동으로 close를 해줌 int count =
		 * sc.nextInt();
		 * 
	 ...
	 * 
	 * @SuppressWarnings("unchecked") public void Add(T a, T b) { T A = a; T B = b;
	 * 
	 * T sum = A + B; } }
	 */
